...
<script	src="${ctx}/static/jquery/jquery-validation/1.11.1/jquery.validate.min.js"	type="text/javascript"></script>
<script src="${ctx}/static/jquery/jquery-validation/1.11.1/messages_zh.js"	type="text/javascript"></script>
